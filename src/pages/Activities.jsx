  ...
  return (
    <section className='mx-auto px-4 mt-16  w-full'>
      <h2 className='text-center text-nunito font-bold text-3xl mb-8'>Our Activities</h2>
       <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4 text-ptSans'>
      {actvitiesData.map((activity)=>(
         <div className='border shadow-xl rounded-lg hover:scale-95 duration-300' key={activity.id}>
